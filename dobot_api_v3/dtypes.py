"""Feedback packet dtype, protocol field map, and typed dataclass for Dobot API.

Extracted from ``base.py`` to separate data-type definitions from the
TCP-communication layer.  ``base.py`` re-exports these symbols for backward
compatibility.
"""
